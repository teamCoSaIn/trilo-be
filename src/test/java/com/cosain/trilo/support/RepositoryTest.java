...
import com.cosain.trilo.trip.query.infra.repository.day.DayQueryRepositoryImpl;
...
@DataJpaTest
@DirtiesContext
@Import({QueryDslConfig.class, TripQueryRepositoryImpl.class, ScheduleQueryRepositoryImpl.class, DayQueryRepositoryImpl.class})
