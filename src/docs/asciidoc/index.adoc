...
=== Trip 수정
operation::trip-update-controller-docs-test/trip-update-doc-test[snippets = 'http-request,path-parameters,request-headers,request-fields,http-response,response-fields']
